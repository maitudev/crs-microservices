// path: courseservice/src/main/java/vn/edu/crs/courseservice/dto/CourseDTO.java
// purpose: DTO dung de nhan du lieu tu client (request) va tra du lieu ve client (response)
